...
pub fn get_ident_req() -> Vec<u8> {
    vec![
        ...
        0x53, 0x37, 0x2d, 0x32, 0x30, 0x30, 0x20, 0x53, 0x4d, 0x41, 0x52, 0x54, 0x00, 0x00, 0x00,
...
pub fn get_get_resp() -> Vec<u8> {
    vec![
        ...
        0x04, 0x00, 0x03, 0x03, 0x3d, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
    ]
}
pub fn get_set_req() -> Vec<u8> {
    vec![
        ...
        0x00, 0x01, 0xc0, 0xa8, 0xc7, 0xf5, 0xff, 0xff, 0xff, 0x00, 0xc0, 0xa8, 0xc7, 0xfe, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ]
}
...
pub fn assert_eq_profinet_packet(packet: &EthernetPacket, origin: &[u8]) {
    ...
    assert_eq!(
        u16_to_u8s(profinet.get_response_delay()).as_slice(),
...
pub fn get_frame_id(data: &[u8]) -> Result<&[u8]> {
    data.get(14..=15).ok_or(anyhow!("数组越界"))
}
...
pub fn get_xid(data: &[u8]) -> Result<&[u8]> {
    data.get(18..=21).ok_or(anyhow!("数组越界"))
}
pub fn get_response_delay(data: &[u8]) -> Result<&[u8]> {
